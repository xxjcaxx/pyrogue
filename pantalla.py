...
class pantalla(object):
 ...
 def __init__(self,t,salas):
  ...
  n = 0
  self.start_maze()
  while self.actual != 'fin':
        n = n+1
        self.grow_maze()
  self.resolver_puertas()
  self.detectar_puntas()
  while len(self.puntas)>0:
       i = self.puntas.pop()
       t = threading.Thread(target=self.borrar_punta(i))
       t.start()
  self.poner_personajes()
  self.poner_puertas()
